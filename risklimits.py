...
def compute_risk_metrics(ORDERS):
    ...
    for idx, row in orders_df.iterrows():
        ...
        orders_df.at[idx, '.005+_overlay'] = orders_df.at[idx,'f_Dv01_pos_pointohoh5'] + orders_df.at[idx,'b_Dv01_pos_pointohoh5']
        ...
        orders_df.at[idx, '.005-_overlay'] = orders_df.at[idx, 'f_Dv01_neg_pointohoh5'] + orders_df.at[idx, 'b_Dv01_neg_pointohoh5']
        ...
        orders_df.at[idx, '.001+_overlay'] = orders_df.at[idx, 'f_Dv01_pos_pointoh1'] + orders_df.at[idx, 'b_Dv01_pos_pointoh1']
        ...
        orders_df.at[idx, '.001-_overlay'] = orders_df.at[idx, 'f_Dv01_neg_pointoh1'] + orders_df.at[idx, 'b_Dv01_neg_pointoh1']
        ...
        orders_df.at[idx, '.05+_overlay'] = orders_df.at[idx, 'f_Dv01_pos_pointoh5'] + orders_df.at[idx, 'b_Dv01_pos_pointoh5']
        ...
        orders_df.at[idx, '.05-_overlay'] = orders_df.at[idx, 'f_Dv01_neg_pointoh5'] + orders_df.at[idx, 'b_Dv01_neg_pointoh5']
        ...
        orders_df.at[idx, '.5+_overlay'] = orders_df.at[idx, 'f_Dv01_pos_point5'] + orders_df.at[idx, 'b_Dv01_pos_point5']
        ...
        orders_df.at[idx, '.5-_overlay'] = orders_df.at[idx, 'f_Dv01_neg_point5'] + orders_df.at[idx, 'b_Dv01_neg_point5']
