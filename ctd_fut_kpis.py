...
import itertools
import pandas as pd
from config import FUTURES, USTs
from cf_ctd import process_futures_ctd
...
HEDGES = process_futures_ctd(FUTURES, USTs)
HEDGES = pd.DataFrame(HEDGES)

# Harmonize column headers by converting all to uppercase.
