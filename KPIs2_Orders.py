...
def calculate_quantities(HEDGES_Combos, SMA):
    ...
    HEDGES_Combos['Base_Ln_A'] = (1 + HEDGES_Combos['ln_A_FUT']/10) # int 20 should be converted to dynamic optimization parameter for later testing
    HEDGES_Combos['Base_Ln_B'] = (1 + HEDGES_Combos['ln_B_FUT']/10)
    ...
    return HEDGES_Combos, ORDERS, config.updated_ORDERS
